    ...
    <div className="about-me" id="about-me">
      <div className="container">
        ...
        <div className="content">
          ...
          <p>
            I'm a full stack software developer with a background in healthcare as a cardiology medical assistant and customer service. I'm people and detail oriented and passionate about being able to bring value to the products that I work on. My previous work experience has taught me how to adapt to people with different needs and work styles, and prepare for emergency situations with strict time management.

            <h1 className="title-about-me">Backstory</h1>
          
            I used to work as a medical assistant and had developed a big passion for helping others. Knowing I made a difference in someone's life or even their day makes me feel like I'm doing something right. As time went by, I realized I wanted more out of life and my career. I wanted a challenge and something to pick my brains. I have always been interested in coding, and with the encouragement and support from family and friends, I decided to take the leap because it's now or never, right?
            <br />
            <br />
